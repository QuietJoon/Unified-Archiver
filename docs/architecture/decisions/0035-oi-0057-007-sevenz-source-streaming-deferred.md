...
* OI-0057-007 in `reviews/Open_Issues.md` is updated to reflect *partial* resolution: LibarchiveArchive and ZipReader sources stream; SevenZ source is deferred to DEF-004, contingent on upstream-crate support.
