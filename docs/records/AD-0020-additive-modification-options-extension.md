---
type: ADR
title: "AD: `Archive::modify_with_options` is an additive extension, not a replacement"
description: "Implemented (Phase B.2 of the in-flight remediation plan)."
tags: [decision, ADR-0020, DCR-001, OI-0025-003, OI-0025-002]
...
- `preserve_metadata`: when `true`, `commit_changes()` preserves timestamps and Unix permissions on retained entries via metadata-aware add helpers (OI-0025-002 resolved 2026-04-14).
...
* Neutral, because `preserve_metadata = true` preserves timestamps and Unix permissions via metadata-aware add helpers (OI-0025-002 resolved 2026-04-14). Comments and extended attributes are not yet preserved.
