---
type: ADR
title: "AD: Reject Review 0060 items already tracked by DEF-* / OI-* entries"
description: "Implemented (review 0060 decisions applied and archived)."
tags: [decision, ADR-0028, R0060-0001, R0060-0002, R0060-0119, R0060-0120, R0060-0121, R0060-0003, OI-0057-007]
...
- **R0060-0119 / R0060-0120 / R0060-0121** — `sevenz_wrapper.rs`, `zip_wrapper.rs`,
  ...
  libarchive actually streams.") and as **OI-0057-007** in `docs/project/open-issues.md`.
...
* Tracked gaps already have exit criteria and owners in `stub-manifest.md` and
  `docs/project/open-issues.md`; an additional accept record in this gate would be duplication.
...
- **DEF-004** in `docs/project/stub-manifest.md` (row 14) — covers R0060-0119
  through R0060-0121.
- **OI-0057-007** in `docs/project/open-issues.md` — covers the ZIP/SevenZ/libarchive
