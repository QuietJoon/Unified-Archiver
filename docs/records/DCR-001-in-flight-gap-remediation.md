...
Closed the documentation-drift item and four of the five in-flight gap categories through the staged remediation plan captured with this DCR:
...
- **ADRs required:** Yes — three new ADRs:
  - `AD-0019-unrar-process-wide-mutex.md`
  - `AD-0020-additive-modification-options-extension.md`
  - `AD-0021-per-entry-creation-progress.md`
...
| `docs/records/0019-…/0020-…/0021-…` | New ADRs |
| `docs/records/README.md` | Index entries for ADRs 0019–0021 |
...
| `docs/project/open-issues.md` | OI-026-004 and OI-027-001 → RESOLVED; OI-025-003 → RESOLVED (2026-04-13) for wiring portion; OI-025-001/OI-025-002 → RESOLVED (2026-04-14) — `preserve_metadata` preserves timestamps and Unix permissions and `compression` overrides recreation settings. |
